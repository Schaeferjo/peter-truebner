  ...
  <v-container>
    <v-row>
      <v-col cols="12" xs="12" sm="12" md="12" lg="12" xl="12">
        ...
        <p>
          <strong> Kürzung der IP-Adresse: </strong> es uns möglich ist oder
          eine Speicherung der IP-Adresse nicht erforderlich ist, kürzen wir
          oder lassen Ihre IP-Adresse kürzen. Im Fall der Kürzung der
          IP-Adresse, auch als "IP-Masking" bezeichnet, wird das letzte Oktett,
          d.h., die letzten beiden Zahlen einer IP-Adresse, gelöscht (die
          IP-Adresse ist in diesem Kontext eine einem Internetanschluss durch
          den Online-Zugangs-Provider individuell zugeordnete Kennung). Mit der
        ...
        <h3 class="pt-8">Bereitstellung des Onlineangebotes und Webhosting</h3>
        <p>
        ...
        <p>
          <strong>Erhebung von Zugriffsdaten und Logfiles:</strong> selbst (bzw.
          unser Webhostinganbieter) erheben Daten zu jedem Zugriff auf den
